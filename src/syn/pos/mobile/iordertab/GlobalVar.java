...
public class GlobalVar {
	...
	public static String				WELCOME_IMG_URL = SERVER_IP + WS_URL + WELCOME_IMG_PATH;
	...
	public static boolean 				isEnableTableQuestion 		= false;
	...
	public GlobalVar(Context context){
		syn.pos.data.dao.ComputerProperty comProp = 
				new syn.pos.data.dao.ComputerProperty(context);
		
		syn.pos.data.dao.ShopProperty sp = new syn.pos.data.dao.ShopProperty(context, null);
		...
		syn.pos.data.dao.GlobalProperty globalProp = 
				new syn.pos.data.dao.GlobalProperty(context, null);

		String decimalPatern = globalProp.getGlobalProperty().getCurrencyFormat() == null ? "#,###.00" : 
			globalProp.getGlobalProperty().getCurrencyFormat();
		...
		syn.pos.data.dao.AppConfig setting
			= new syn.pos.data.dao.AppConfig(context);
		...
		WELCOME_IMG_URL = SERVER_IP + appModel.getWebServiceUrl() + WELCOME_IMG_PATH;
		DISPLAY_MENU_IMG = appModel.getDisplayImageMenu();
		
		ShowMenuColumnName showColName = 
				new ShowMenuColumnName(context);
